...
// session.sse() opens the channel (triggering the server's open PI creation),
// streams tokens, and handles voucher renewals automatically.
...
// close() settles on-chain and triggers the server's PI confirmation.
